import 'dart:async';
import 'package:ankitpaswan_21rdfpp/widgets/bottom_nav.dart';
import 'package:ankitpaswan_21rdfpp/widgets/color_tile.dart';
import 'package:ankitpaswan_21rdfpp/widgets/scene_tile.dart';
...
class _BedroomState extends State<Bedroom> {
  ...
  Offset _lightBulbOffset = Offset(0, -.3);
  Offset _containerOffset = Offset(0, -.2);
  Offset _listTileOffset = Offset(1, 0);
  _BedroomState() {
    transition();
  }
  transition() {
    Timer(const Duration(milliseconds: 500), () {
      setState(() {
        _containerOffset = Offset(0, 0);
      });
    });
    Timer(Duration(seconds: 1), () {
      setState(() {
        _listTileOffset = Offset(0, 0);
      });
    });
    Timer(Duration(seconds: 1), () {
      setState(() {
        _lightBulbOffset = Offset(0, 0);
      });
    });
  }
                        ...
                        Positioned(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: _currentColor.desaturate(
                              ...
                              Row(
                                ...
                                children: [
                                  GestureDetector(
                                      ...
                                      child:
                                          ColorTile(color: Color(0xffFF9B9B))),
                                  GestureDetector(
                                      onTap: () {
                                        setState(() {
                                      ...
                                      child:
                                          ColorTile(color: Color(0xff94EB9E))),
                                  GestureDetector(
                                      onTap: () {
                                        setState(() {
                                      ...
                                      child:
                                          ColorTile(color: Color(0xff94CAEB))),
                                  GestureDetector(
                                      onTap: () {
                                        setState(() {
                                      ...
                                      child:
                                          ColorTile(color: Color(0xffA594EB))),
                                  GestureDetector(
                                      onTap: () {
                                        setState(() {
                                      ...
                                      child:
                                          ColorTile(color: Color(0xffDE94EB))),
                                  GestureDetector(
                                      onTap: () {
                                        setState(() {
                                      ...
                                      child:
                                          ColorTile(color: Color(0xffEBD094))),
                                  Container(
                                    height: 40,
                                    width: 40,
                                    decoration: BoxDecoration(
